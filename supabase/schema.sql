...
create table if not exists public.projects (
  ...
  kapak       text default '',
  kapak_video text default '',
  galeri_1    text default '',
  galeri_1_video text default '',
  galeri_2    text default '',
  galeri_2_video text default '',
  galeri_3    text default '',
  galeri_3_video text default '',
  galeri_4    text default '',
  galeri_4_video text default '',
  galeri_5    text default '',
  galeri_5_video text default '',
  galeri_6    text default '',
  galeri_6_video text default '',
  galeri_7    text default '',
  galeri_7_video text default '',
  galeri_8    text default '',
  galeri_8_video text default '',
  galeri_9    text default '',
  galeri_9_video text default '',
  galeri_10   text default '',
  galeri_10_video text default '',
...
-- Canonical iş kategorileri (Table Editor referansı; projects.kategori = label)
...
comment on column public.projects.kategori is
  'İş kategorisi. Geçerli değerler: project_categories.label (ör. Packaging).';
...
-- ── Site events (birinci taraf analitik; /api/track service_role yazar) ──
...
-- ── Anlık ziyaretçi (/api/presence heartbeat) ──
