...
const branding: Project[] = [
  make({
    ...
    yil: "2024",
    musteri: "Karamel Coffee",
    rol: "Marka Tasarımcısı",
    sure: "6 hafta",
...
const packaging: Project[] = [
  make({
    ...
    yil: "2024",
    musteri: "Terra Tea Co.",
    rol: "Ambalaj Tasarımcısı",
    sure: "5 hafta",
    link: "",
    featured: true,
    renk: "#6E8B3D",
...
const social: Project[] = [
  ...
  make({
    ...
    yil: "2024",
    musteri: "Yolculuk Hotel",
    rol: "Creative Direction",
    sure: "6 hafta",
    link: "",
    featured: false,
    renk: "#A2B8C9",
