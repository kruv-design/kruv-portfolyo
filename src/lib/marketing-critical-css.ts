...
#nav-sentinel, .marketing-nav-sentinel { height: 1px; width: 100%; margin: 0 0 -1px; padding: 0; }
...
.hero-v2-copy { background: var(--midnight); min-height: min(72svh, 40rem); display: flex; align-items: center; justify-content: center; }
`.trim();
